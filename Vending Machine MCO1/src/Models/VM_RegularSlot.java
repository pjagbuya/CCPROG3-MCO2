...
/** The class VM_Slot represents a regular slot of the VM
  *
  * @author Paul Josef P. Agbuya
  * @author Vince Kenneth D. Rojo
  * @version 1.0
  */
public class VM_RegularSlot extends VM_Slot
{
    /**
     ...
     */
    public VM_RegularSlot(int capacity)
	{
		super(capacity);
    }
     ...
     * 
     */
	public VM_RegularSlot(VM_Slot copy)
    {
		super(copy);
    }
}