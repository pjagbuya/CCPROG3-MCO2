...
public class DispensedItemView extends ScrollPane
{
    public DispensedItemView()
    {
        ...
        dispensedSectionGridPane.add(this.mainCanvasVBox, 1, 0);
    ...
    public void addItemSelected(StackPane item)
    {
        dispensedSectionGridPane.getChildren().remove(itemSelectedStackPane);
        this.itemSelectedStackPane = item;
        this.itemSelectedStackPane.setPrefHeight(200);
        this.itemSelectedStackPane.setPrefWidth(200);
        this.dispensedSectionGridPane.add(this.itemSelectedStackPane, 0, 0);
