...
public class Money {
	...
	public double convertStringToMoneyVal(String name)
	{
		return strToVal.get(name);
	}
	public String convertMoneyValToString(double val)
	{


		return valToStr.get(val);
	 ...
	 **/
	public LinkedHashMap<String, Double> getStrToVal() {
		return strToVal;
	}
	 ...
	 **/
	public LinkedHashMap<Double, String> getValToStr() {
		return valToStr;
	}
